...
<div class="page-wrapper">
    ...
    <header class="page-header">
        ...
        <a href="{{ url('/reportes/docentes/general/grafico') }}" class="btn-gold">
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions-cell">
                            <a href="{{ url('reportes/docentes/escuela/'.$e->COD_ESCUELA) }}" class="btn-action btn-pdf">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"/>
                                </svg>
                                Descargar PDF
                    ...
                    <td>
                        <div class="actions-cell">
                            <a href="{{ url('/reportes/docentes/escuela/grafico/'.$e->COD_ESCUELA) }}" class="btn-action btn-chart">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
